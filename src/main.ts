...
import { RefCanvasDatabase } from "./main/database";
import {
  LibraryManager,
  backupDirectoryFor,
  databasePathFor,
...
import { LibraryService } from "./main/library-service";
import { FilesystemService } from "./main/filesystem-service";
import { DirectoryIndexClient } from "./main/directory-index-client";
import { DirectoryBatchService } from "./main/directory-batch-service";
import { PreviewTokenRegistry } from "./main/refbrowse";
import { PreviewQueue } from "./main/preview-queue";
import { PreviewCacheIndex } from "./main/preview-cache-index";
import { ThumbnailWorkerClient } from "./main/thumbnail-worker-client";
import { registerProtocols } from "./main/protocols";
import {
  registerWindowsProjectFormat,
  registerWindowsSendTo,
  removeWindowsIntegration,
  updateSquirrelShortcut,
} from "./main/windows-integration";
import { SecureIpcRegistrar } from "./main/secure-ipc";
import { registerActionIpc } from "./main/ipc/action-ipc";
import { registerBackupIpc } from "./main/ipc/backup-ipc";
import { registerBoardIpc } from "./main/ipc/board-ipc";
import { boardDocumentSchema } from "./main/ipc/board-schema";
import { registerFilesystemIpc } from "./main/ipc/filesystem-ipc";
import { registerLibraryIpc } from "./main/ipc/library-ipc";
import { registerLibraryManagementIpc } from "./main/ipc/library-management-ipc";
import { registerMediaNotesIpc } from "./main/ipc/media-notes-ipc";
import { registerSystemIpc } from "./main/ipc/system-ipc";
import {
