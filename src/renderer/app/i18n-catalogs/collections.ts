...
export const catalog = {
  ...
  zhCN: {
    ...
    "collections.description": "把不同文件夹的素材收藏到一起，不复制或移动源文件。",
    "collections.create": "新建收藏夹",
    "collections.addFiles": "添加文件…",
    "collections.createFromFiles": "选文件并新建收藏夹…",
    "collections.newChild": "新建子收藏夹",
    "collections.rename": "重命名",
    "collections.delete": "删除收藏夹",
    ...
    "collections.emptyHint": "把素材拖到这里，或点击收藏夹旁的 + 添加。",
    ...
    "collections.nameLabel": "收藏夹名称",
    "collections.childNameLabel": "子收藏夹名称",
