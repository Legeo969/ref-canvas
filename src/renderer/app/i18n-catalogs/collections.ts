...
export const catalog = {
  en: {
    ...
    "collections.deleteSelectedFiles": "Delete {count} source files?",
    "collections.deleteSelectedFilesDesc": "The selected source files will move to the system Recycle Bin and their collection references will be removed.",
  ...
  zhCN: {
    ...
    "collections.deleteSelectedFiles": "删除 {count} 个源文件？",
    "collections.deleteSelectedFilesDesc": "选中的源文件将移入系统回收站，同时移除集合引用。",
