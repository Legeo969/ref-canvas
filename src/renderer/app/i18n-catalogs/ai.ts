...
export const catalog = {
  en: {
    ...
    "ai.original.placeholder": "Feedback on the original design; paste reference images or chat screenshots (0/6)",
    "ai.original.dropOrPaste": "Drop or right-click paste the original design",
    "ai.original.majorChange": "Major changes needed",
    "ai.original.professionalModify": "Professional modify",
    "ai.original.imageUnit": "images",
  ...
  zhCN: {
    ...
    "ai.original.placeholder": "输入对原图的设计反馈，支持粘贴参考图或聊天记录截图 (0/6)",
    "ai.original.dropOrPaste": "拖放或右键粘贴原始设计",
    "ai.original.majorChange": "需要较大改动",
    "ai.original.professionalModify": "专业修改",
    "ai.original.imageUnit": "张",
    "aiSettings.fileFilterWorkflow": "API workflow JSON",
  },
